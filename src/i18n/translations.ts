...
export const translations = {
  en: {
    ...
    stealAttempt: 'Steal attempt! Roll the inherited dice or decline',
    ...
    helpStealing: 'Stealing Points',
    helpStealingText: 'If someone banks with dice remaining, the next player can try to "steal" those points by continuing where they left off. But you must roll first - if you bust, you get nothing!',
  ...
  pt: {
    ...
    stealAttempt: 'Tentativa de roubo! Role os dados herdados ou recuse',
    ...
    helpStealing: 'Roubando Pontos',
    helpStealingText: 'Se alguém guardar pontos com dados restantes, o próximo jogador pode tentar "roubar" esses pontos continuando de onde parou. Mas você deve rolar primeiro - se estourar, não ganha nada!',
